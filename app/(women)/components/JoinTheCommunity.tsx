...
export function JoinTheCommunity() {
  return (
    <section className="relative text-base-100 font-serif text-center">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="absolute inset-0 w-full h-full bg-base-content/50 flex flex-col items-center justify-center px-6 lg:px-12 xl:px-32 text-balance">
        <div className="max-w-[var(--width-max)] flex flex-col items-center">
          ...
          <p className="mt-8 md:mt-10 lg:mt-18 xl:mt-20 text-lg md:text-[22px] lg:text-[28px]">
            ...
            you are. Our commitment to you is simple: to help you feel your
            best, both inside and out. To show you how you can achieve your hair
            goals through whole-body health. And to be with you every step of
            the way. Our Shed the Silence community was created to ensure you’re
            never alone on your hair journey. It’s a place where you can share
            your experience with people who get it, offer support, and tackle
            hair struggles together. Because hair is never “just” hair. So,
