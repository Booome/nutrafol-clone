...
export function FindYourRootCause() {
  return (
    <div className="max-w-[var(--width-max)] mx-auto flex flex-col items-center bg-base-100 pt-12 px-6 md:px-8 lg:px-12 xl:px-24 pb-10 lg:pb-16">
      ...
      <LinkButton href="/" className="mt-8 lg:mt-14">
        Take the Quiz to Find Your Root Causes
      </LinkButton>
    </div>
  );
}
